export const defaultListsData = [
  {
    ...
    listItem: ["Logo Design", "Web Design & Development", "E-Commerce", "SEO"],
  },
  {
    title: "Active lists",
    subTitle: [
    ...
    listItem: ["UI Kits", "Wow Animations", "Apex Charts", "Starter Kits"],
  },
  {
    title: "Flush lists",
    subTitle: [
    ...
    class: "flush",
    listItem: ["PRODUCT", "PRODUCT DETAILS", "CART", "CHECKOUT"],
  },
];

export const contextualListsData = [
  {
    color: "secondary",
    title: "Secondary",
  },
...
export const ContextualClassTopdata = [
  {
...
export const CustomListTopData = [
  {
    text: "Use the ",
    code: ".list-group-item",
  },
...
export const ListNumberTopData = [
  {
    text: "Use the ",
    code: ".list-group-numbered",
  },
...
export const ListWithCheckboxTopData = [
  {
    text: "Use the ",
