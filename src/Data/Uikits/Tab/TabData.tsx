...
export const simpleTabData = [
  ...
  },
  {
    ...
    text: (
      <p className='pt-3'>
        {" "}
        Us Technology offers web &amp; mobile development solutions for all industry verticals.Include a short form using fields that will help your business understand who's contacting them. <br />
        <strong>Visit Us: </strong> 2600 Hollywood Blvd,Florida, United States- 33020
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <div className='pt-3'>
          {" "}
          <Label htmlFor='exampleFormControlInput1'>{Emailaddress}</Label> <Input id='exampleFormControlInput1' type='email' placeholder='youremail@gmail.com' />
        </div>
      </>
    ),
  },
  ...
  },
  {
    ...
    text: (
      <p>
        ...
        <br />
        Typography is the art of arranging letters and text in a way that makes the copy legible, clear, and visually appealing to the reader. <br />
        <strong> Tooltip: </strong>
        <br />A tooltip is a brief, informative message that appears when a user interacts with an element in a graphical user interface (GUI).
      </p>
    ),
  },
  {
...
export const leftTabData = [
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <div className='flex-space flex-wrap align-items-center'>
          {" "}
          <Image className='tab-img' src={`${ImagePath}/ecommerce/08.jpg`} alt='profile' width={100} height={100} />
          <p>
            {" "}
        ...
        <div className='main-inbox'>
          ...
          <div className='header-inbox justify-content-start gap-2'>
            <div className='header-left-inbox'>
              ...
              <div className='inbox-img'>
                {" "}
                <Image src={`${ImagePath}/ecommerce/07.jpg`} alt='profile' width={100} height={100} />{" "}
              </div>
            </div>
            <div className='inbox-content'>
              {" "}
              <h6>Dalbult Caslin </h6> <p className='text-muted'>stroman.rogers@gmail.com</p>{" "}
            </div>{" "}
          </div>{" "}
          <div className='body-inbox mt-2'>
            ...
            <div className='body-h-wrapper'>
              {" "}
              <i className='me-2 tab-space icofont icofont-star' /> <em>Compare Prices Find the Best Computer Assessors Fronted Issue.</em>{" "}
            </div>
  ...
  },
  {
    ...
    text: (
      <p>
        {" "}
        <strong> In this situation, you would probably do two things:</strong> 'exit the page, or look for the trusty search bar. If you decide to stick around, a proper search function should take your query and send you to your destination. Problem solved. It's not a perfect experience, but it's a hard one to avoid on larger websites that simply can't link to every piece of content from the homepage.'
      </p>
    ),
  },
];
      ...
      <CardBody className='pb-0'>
        ...
        <div className='main-inbox'>
          <div className='header-inbox'>
            ...
            <div className='header-left-inbox'>
              <div className='inbox-img'>
                <Image src={`${ImagePath}/ecommerce/06.jpg`} alt='profile' width={100} height={100} />{" "}
              </div>{" "}
              <div className='inbox-content'>
                <h6>Dalbult Caslin </h6> <p className='text-muted'>stroman.rogers@gmail.com</p>{" "}
              </div>{" "}
    ...
    text: (
      <CardBody className='px-0 pb-0'>
        ...
        <Form>
          ...
          <div className='mb-0'>
            {" "}
            <Label htmlFor='exampleFormControlTextarea1'>Example textarea</Label> <textarea className='form-control' id='exampleFormControlTextarea1' rows={3}></textarea>{" "}
          </div>{" "}
        </Form>{" "}
      </CardBody>
    ),
