...
import { AjaxSourcedColumnsInterface, CustomCellInterFace, HtmlColumnsInterface, ServerSideProcessingColumnsType } from "@/Types/DataTablesTypes";
  ...
  export const htmlColumns = [
    ...
    },
    {
      ...
      selector: (row: HtmlColumnsInterface) => (
        <CustomBadge color={row.color} position={row.badge} value={0} />
      ),
      sortable: true,
      center: false,
    },
