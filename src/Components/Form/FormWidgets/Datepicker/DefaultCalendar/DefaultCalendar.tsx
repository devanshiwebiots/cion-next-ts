          ...
          <Row className='g-3'>
            <Col xs={12}>
              <InputGroup className='main-inline-calender'>
                <Input placeholder={`${dateValue.getDate()}- ${dateValue.getMonth() + 1} - ${dateValue.getFullYear()} `} className='mb-2 flatpickr-input' />
                <Calendar onChange={(value) => setDateValue(value)} value={dateValue} className='w-100 border-none'/>
              </InputGroup>
            </Col>
          </Row>
        </CardBody>
