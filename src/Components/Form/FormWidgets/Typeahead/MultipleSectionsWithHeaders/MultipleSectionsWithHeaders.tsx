...
import { multipleSelectionData, multipleWithHeadersData } from "@/Data/Form/FormWidgets/TypeaheadData";
        ...
        <CardBody>
          <div id='multiple-datasets'>
            <Form className='theme-form'>
              <div>
                <Typeahead options={multipleWithHeadersData} placeholder='NBA and NHL teams' labelKey='name' renderMenu={renderMenu} multiple id='1' />
              </div>
            </Form>
          </div>
        </CardBody>
