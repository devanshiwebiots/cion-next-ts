...
import { CommonPrefixAndPostFixPropsType } from "@/Types/FormWingetsType";

const CommonPrefixAndPostFix: React.FC<CommonPrefixAndPostFixPropsType> = ({ postIcon, preIcon, preButton, PostButton, differentColor }) => {
