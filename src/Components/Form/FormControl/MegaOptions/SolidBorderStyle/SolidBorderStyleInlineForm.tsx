...
import { solidBorderStyleInlineFormData } from "@/Data/Form/FormControl/FormControlData";
                    ...
                    <Media body>
                      <span className='d-flex list-behavior-1'>
                        <span className='flex-shrink-0'>
                          <Image height={86} width={138} className='tab-img img-fluid' src={`${ImagePath}/${data.imagePath}`} alt='home' />
                        </span>
