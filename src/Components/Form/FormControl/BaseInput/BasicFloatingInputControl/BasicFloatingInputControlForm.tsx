        ...
        <Row>
          <Col>
            ...
            <Row className="mb-3">
                ...
                <Col sm={9}>
                    <FormGroup floating>
                        <Input type="textarea" style={{ height: 100 }} defaultValue={""}/>
                        <Label>{CommentsHeading}</Label>
                    </FormGroup>
                </Col>
            </Row>
            <Row className="mb-3">
                ...
                <Col sm={9}>
                    <FormGroup floating>
                        <Input type="select" defaultValue={OpenThisSelectMenu}>
            ...
            <Row className="mb-3">
                ...
                <Col sm={9}>
                    <InputGroup>
                        ...
                        <div className="form-floating custom-user-input">
                ...
                <Row>
                    ...
                    <Col sm={9}>
                        <InputGroup className="has-validation">
                            <InputGroupText>@</InputGroupText>
                            <div className="form-floating is-invalid mb-0">
