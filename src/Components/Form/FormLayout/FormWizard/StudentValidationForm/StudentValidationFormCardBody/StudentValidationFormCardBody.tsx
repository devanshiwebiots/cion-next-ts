...
const StudentValidationFormCardBody = () => {
  ...
  return <StudentForm handleImageLabelClick={handleImageLabelClick} handleBackButton={handleBackButton} imageUrl={imageUrl} fileInputRef={fileInputRef} handleNextButton={handleNextButton} getUserData={getUserData} studentValidationForm={studentValidationForm} level={level} />;
};
