...
import { numberingWizardHeadingData } from "@/Data/Form/FormLayout/FormWizardData";
      ...
      <Card className='height-equal'>
        ...
        <CardBody className='basic-wizard important-validation'>
          ...
          <div className='wizard-footer d-flex gap-2 justify-content-end'>
            {level > 1 && (
              <Button className='alert-light-primary' color='transparent' onClick={handleBackButton}>
                {Back}
              </Button>
            )}
            <Button disabled={showFinish ? true : false} color='primary' onClick={handleNextButton}>
