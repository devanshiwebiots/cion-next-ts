...
export const WelltechHeadphoneBluetooth = "Welltech SH 12 Bluetooth Headphone Bluetooth";
...
export const Scroll1 = (
  <>
    Inspiration can take many different forms, and <em className='txt-danger'>professional growth never stops</em>
...
export const Collapsedtostart = "Collapsed to start, horizontal above breakpoints";
...
export const Checktext = "You accept our Terms and Privacy Policy by clicking Submit below.";
...
export const RemoveaccountText = "Remove your complete account from your phone or tablet to sign out of the Gmail app.";
...
export const BasicCardText = (
  <>
    ...
    <em className='txt-danger'>“module tabs”</em> , these are still used today in web sites. For instance, airline companies such as Ryanair, easyJet and AirMalta use module tabs to enable the user to switch between bookings for flights, hotels and car hire.
  </>
);
...
export const FlatCardText = (
  <>
    ...
    <em className='txt-danger'> important pages on your website</em> , like your blog, product pages, pricing, contact info, and documentation. This improves the chances of visitors browsing your site longer, which can boost your page views and reduce your bounce rate.
  </>
);
...
export const BorderleftText = "Us Technology offers web & mobile development solutions for all industry verticals.Include a short form using fields that'll help your business understand who's contacting them.";
...
export const BorderRightText = "Us Technology offers web & mobile development solutions for all industry verticals.Include a short form using fields that'll help your business understand who's contacting them. ";
...
export const BorderWarningtext = "known for delivery of useful and usable solutions";
...
export const AbsolutePrimarytext = "We provide end to end digital solutions, right from designing your website/application development: Domain, Web Hosting, Email Hosting Registration, Search Engine Optimization and other Internet Marketing, Renewal of Services timely and effectively.";
export const AbsoluteSecondarytext = "When someone visits your homepage, your design should inspire them to stay. Therefore, your value proposition should be established on the homepage for visitors to select to stay on your website.Building trust, expressing value,to the next step all depend on a page's design.";
...
export const Locationtext = "What a dynamic performance by the eighth-grade students, Let's welcome the ninth-grade kid to the stage.";
...
export const TimeLineData2 = (
  <div className='cd-timeline-content'>
    ...
    <p className='mb-0'>
      Challenges <em className='txt-danger'>help you build problem-solving skills, better understand the programming. </em>If you want to improve your skills in programming.{" "}
    </p>
...
export const TimeLineData3 = (
  <div className='cd-timeline-content'>
    ...
    <Carousel>
      <div>
        <Image className='d-block w-100' src={`${ImagePath}/banner/1.jpg`} height={274} width={413} alt='office-work' />
      </div>
      <div>
        <Image className='d-block w-100' src={`${ImagePath}/banner/2.jpg`} height={274} width={413} alt='office-work' />
      </div>
      <div>
        <Image className='d-block w-100' src={`${ImagePath}/banner/3.jpg`} height={274} width={413} alt='office-work' />
      </div>
    </Carousel>
  </div>
);
...
export const TrashBin = "TrashBin";
