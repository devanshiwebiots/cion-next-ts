...
import { ListOfMenuProp } from "@/Types/BookmarkType";
...
const ListOfMenu = (props: ListOfMenuProp) => {
  ...
  return (
    <div className={`${searchBar ? `Typeahead-menu theme-scrollbar ${searchToggle ? "is-open" : ""}` : `filled-bookmark Typeahead-menu  ${searchValue.length > 0 ? " is-open" : ""} custom-scrollbar`} `} id='search-outer'>
      {searchValue &&
            ...
            <div className='ProfileCard u-cf' key={index}>
              ...
              <div className='ProfileCard-details'>
                <div className='ProfileCard-realName'>
                  <Link href={`${data?.url}`} className='realname' onClick={removeFix}>
                    {data.title}
                  </Link>
                  {searchBar ? (
                    ""
